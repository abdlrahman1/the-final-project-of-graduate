...
if(isset($_SESSION["user"]["role"]) == "admin"){
    ...
    echo "<div class='publish_con_book'>
    <form method='post' enctype='multipart/form-data'>
    <div class='publish_con_book_child'>
    <h1> انشر كتاب </h1>
    <input type='text' name='title' placeholder='العنوان اجباري ! '>
    ...
    <input type='text'name='subheading2' placeholder='عنوان فرعي 2 اختياري'>
    ...
    <input type='text'name='subheading4' placeholder='عنوان فرعي2 اختياري'>
    <textarea name='content4' placholder = 'محتوي 4 اجباري'> </textarea>
    ...
    if(isset($_POST["publish_btn"])){
        if (empty($_POST["title"]) || empty($_POST["subheading"]) || empty($_FILES["img_title"]["tmp_name"]) || empty(trim($_POST["content"]))) {
            ...
            if(isset($content) && !empty($content)){
                ...
                $target_dir = 'D:\xampp\htdocs\php code\hims_final_project\books/';
...
<link rel="stylesheet" href="css/publish_books.css"/>
</head>
<body>
